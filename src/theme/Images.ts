...
export default function ({}: ThemeVariables) {
  return {
    ...
    sparkles: {
     ...
     Denamon:require('./assets/images/Denamon.jpg'),
     Bca:require('./assets/images/bca.jpg'),
     Balon:require('./assets/images/Balon.png'),
     BackgroudEcomerrs:require('./assets/images/BckgroundEcomerrs.png'),
     BackgroudEmoney:require('./assets/images/iconemoney.png'),
     mainten:require('./assets/images/mainten.png'),
     creadit:require('./assets/images/CreditCard.png'),
     BackgroudTv:require('./assets/images/tvKABEL.png'),
     BackgroudPLN:require('./assets/images/pln.png'),
     BackgroudElectrick:require('./assets/images/backgroundElectricity.png'),
     Meteran:require('./assets/images/Meteran.jpg'),
    },
    icons: {
      ...
      iconkredit:require('./assets/images/card1212.png'),
      iconAdd:require('./assets/images/Add.png'),
      iconScan2:require('./assets/images/IconScan12.png'),
      iconSendChat:require('./assets/images/sendtochat.png'),
      iconClock:require('./assets/images/clock.png'),
      iconClock2:require('./assets/images/Clock2.png'),
    },
  };
}
