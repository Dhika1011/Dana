...
const EcommerceDetail = (props: any) => {
  const {
    Common,
    Fonts,
    Gutters,
  ...
  const Ecommerce = props.route.params.item;
  console.log('Ecommercet', Ecommerce);
  ('use strict');
  ...
  return (
    <View style={{ flex: 1, backgroundColor: Colors.white }}>
      ...
      >
        ...
        >
          <Image
            source={Images.sparkles.BackgroudEcomerrs}
        ...
        <View style={{ marginHorizontal: 20, top: responsiveHeight(-2) }}>
          ...
          <View style={[{ marginHorizontal: 10, marginRight: 45 }]}>
            <Input
              placeholder="Pleasetype your Number"
              value={Number}
        ...
        <View style={styles.linearGradient}>
          ...
          <View>
            ...
            >
              DANA accepts payment to Permata, BNI,
            </Text>
            <View>
              <Text
                style={[
